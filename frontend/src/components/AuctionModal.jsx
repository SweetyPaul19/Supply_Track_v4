...
export default function AuctionModal({ auctionData, onClose }) {
  ...
  return (
    <div style={overlayStyle}>
      <div style={{
        ...modalBase,
        border: `4px solid ${isWinning ? '#22c55e' : urgency ? '#ef4444' : '#3b82f6'}`,
        boxShadow: `0 0 60px ${isWinning ? 'rgba(34,197,94,0.3)' : urgency ? 'rgba(239,68,68,0.4)' : 'rgba(59,130,246,0.2)'}`,
        animation: urgency ? 'shake 0.5s infinite' : 'none',
      }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', marginBottom: '6px' }}>
            ...
            <span style={{ fontWeight: 900, fontSize: '18px', color: '#ef4444', letterSpacing: '1px' }}>FLASH AUCTION LIVE</span>
            <span style={{ fontSize: '20px' }}>🚨</span>
          </div>
          <div style={{ color: '#94a3b8', fontSize: '13px' }}>
            Truck <strong style={{ color: '#60a5fa' }}>{auctionData.truck_id}</strong> · Spoilage Alert
          </div>
        </div>

        {/* Batch item */}
        <div style={{ background: '#0f172a', borderRadius: '10px', padding: '12px 16px', marginBottom: '16px', borderLeft: '4px solid #ef4444' }}>
          <div style={{ fontSize: '11px', color: '#64748b', textTransform: 'uppercase', marginBottom: '4px' }}>Batch for Auction</div>
